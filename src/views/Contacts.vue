  ...
  <div>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        ...
        <h6 style="font-weight: bold">Complaint Form</h6>
        <p>
          Kindly fill the form to lodge any complaints you might have for us
        </p>
      </div>
      <!-- End Page Title -->
          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Vertical Form -->
                <form class="row g-3" @submit="handleContact">
                  <div class="col-6">
...
import Conts from "../models/cont.js";
export default {
  name: "Contact",
  data() {
    return {
